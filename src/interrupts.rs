...
// but typically the range 32–47 is chosen, because these are the first free numbers
// after the 32 exception slots.
...
extern "x86-interrupt" fn keyboard_interrupt_handler(_stack_frame: &mut InterruptStackFrame) {
    ...
    let mut keyborad = KEYBOARD.lock();
...
extern "x86-interrupt" fn page_fault_handler(
    ...
    println!("{:#?}", stack_frame);
    // It will thrown page fault exception continously, so use hlt_loop here.
    // TODO: why?
    hlt_loop();
}
